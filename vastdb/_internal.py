...
class VastdbApi:
    ...
    def create_table(self, bucket, schema, name, arrow_schema=None, txid=0, client_tags=[], expected_retvals=[],
                     ...
                     message_timestamp_type=None, retention_ms=None, past_threshold_ts=None, future_threshold_ts=None):
        """
        ...
        if topic_partitions > 0:
            table_props = _encode_table_props(message_timestamp_type=message_timestamp_type, retention_ms=retention_ms, past_threshold_ts=past_threshold_ts, future_threshold_ts=future_threshold_ts)
    ...
    def alter_table(self, bucket, schema, name, txid=0, client_tags=[], table_properties="",
        ...
        if message_timestamp_type is not None or retention_ms is not None or past_threshold_ts is not None or future_threshold_ts is not None:
            table_properties = _encode_table_props(message_timestamp_type=message_timestamp_type, retention_ms=retention_ms, past_threshold_ts=past_threshold_ts, future_threshold_ts=future_threshold_ts)
